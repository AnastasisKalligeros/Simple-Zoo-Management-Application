...
public class Reptiles implements Serializable { // ερπετά

    private static List<String> name = new ArrayList<>(); // η λίστα περιέχει τα ονόματα των ερπετών.
    private static List<Integer> code = new ArrayList<>(); // η λίστα περιέχει τους κωδικούς των ερπετών.
    private static List<Integer> weight = new ArrayList<>(); // η λίστα περιέχει το βάρος των ερπετών.
    private static List<Integer> age = new ArrayList<>(); // η λίστα περιέχει τη μέγιστη ηλικία των ερπετών.
